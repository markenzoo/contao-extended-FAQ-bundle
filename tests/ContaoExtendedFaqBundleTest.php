...
namespace Markenzoo\ContaoExtendedFaqBundle\Tests;
...
class ContaoExtendedFaqBundleTest extends TestCase
{
    ...
    {
        $bundle = new ContaoExtendedFaqBundle();

        $this->assertInstanceOf('Markenzoo\ContaoExtendedFaqBundle\ContaoExtendedFaqBundle', $bundle);
    }
}
